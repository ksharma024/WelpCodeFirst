...
namespace WelpCodeFirst.Models
{
    public class RatingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RatingID,UserID,BusinessID,StarRating,Review")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RatingID,UserID,BusinessID,StarRating,Review")] Rating rating)
        {
            if (ModelState.IsValid)
            {
